...
- **Menu Key → Right Click** → The Menu/Application key on PC keyboards (key code 0x6E) posts a right-click at the current mouse position. Own handler class (`MenuKeyHandler`), own UserDefaults key (`menuKeyRightClickEnabled`). Disabled by default.
